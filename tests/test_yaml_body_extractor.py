...
from nero.modules import YAMLBodyExtractor
...
class TestYAMLBodyExtractor(unittest.TestCase):
    ...
    def test_yaml_body_extractor(self):
        ...
        module = YAMLBodyExtractor(None, dynamic_memory)
        ...
        self.assertListEqual(
            ...
            sorted(["/path1/path2.php", "/file1.html", "/file2.rss", "/api/v1/", "/search/کلمه فارسی"])
        )
